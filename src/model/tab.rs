...
pub struct ConsoleTab {
    ...
    pub pending_catalog_change_impact: crate::sql::CatalogChangeImpact,
    pub last_execution: Option<LastExecution>,
    pub execution_target: Option<ExecutionTarget>,
    pub execution_connection: Option<ConnectionIdentity>,
...
impl ConsoleTab {
    ...
    pub fn new(name: impl Into<String>) -> Self {
        Self {
            ...
            pending_catalog_change_impact: crate::sql::CatalogChangeImpact::None,
            last_execution: None,
